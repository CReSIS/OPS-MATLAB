function opsInsertLayerFromGrid(param,proj,X,Y,layers)
% opsInsertLayerFromGrid(param,proj,X,Y,layers)
%
...
load('/scratch/csarp_support/frames/snow/2014_Greenland_P3/frames_20140312_03.mat')
records = load('/scratch/csarp_support/records/snow/2014_Greenland_P3/records_20140312_03.mat')



load('/scratch/csarp_support/frames/snow/2014_Greenland_P3/frames_20140324_02.mat')
records = load('/scratch/csarp_support/records/snow/2014_Greenland_P3/records_20140324_02.mat')
